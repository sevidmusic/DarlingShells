...
alias archVB="ssh-keygen -f \"/home/sevidmusic/.ssh/known_hosts\" -R \"[127.0.0.1]:3022\" && ssh -p 3022 darling@127.0.0.1"
alias newsboat="newsboat -u ~/.newsboatfeeds"
alias hdinfo="df -H | grep -E 'Filesystem|sda1'"
