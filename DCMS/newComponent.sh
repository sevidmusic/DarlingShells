...
showInfoPanel() {
  printf "\n\n%s----- Info Panel -----%s" "${CLEARCOLOR}${HIGHLIGHTCOLOR2}${DARKTEXTCOLOR}" "${CLEARCOLOR}"
  printf "\n  %sExtending: %s" "${CLEARCOLOR}${NOTIFYCOLOR}" "${CLEARCOLOR}${HIGHLIGHTCOLOR}${EXTENDING}${CLEARCOLOR}"
  printf "\n  %sTemplate: %s" "${CLEARCOLOR}${NOTIFYCOLOR}" "${CLEARCOLOR}${HIGHLIGHTCOLOR}${TEMPLATE}${CLEARCOLOR}"
  printf "\n  %sExtension Name: %s" "${CLEARCOLOR}${NOTIFYCOLOR}" "${CLEARCOLOR}${HIGHLIGHTCOLOR}${EXTENSION_NAME}${CLEARCOLOR}"
  printf "\n  %sParent Component Name: %s" "${CLEARCOLOR}${NOTIFYCOLOR}" "${CLEARCOLOR}${HIGHLIGHTCOLOR}${USER_DEFINED_PARENT_COMPONENT_NAME}${CLEARCOLOR}"
  printf "\n  %sParent Component Sub-type: %s" "${CLEARCOLOR}${NOTIFYCOLOR}" "${CLEARCOLOR}${HIGHLIGHTCOLOR}${USER_DEFINED_PARENT_COMPONENT_SUBTYPE}${CLEARCOLOR}"
  printf "\n  %sComponent Name: %s" "${CLEARCOLOR}${NOTIFYCOLOR}" "${CLEARCOLOR}${HIGHLIGHTCOLOR}${USER_DEFINED_COMPONENT_NAME}${CLEARCOLOR}"
  printf "\n  %sComponent Sub-type: %s" "${CLEARCOLOR}${NOTIFYCOLOR}" "${CLEARCOLOR}${HIGHLIGHTCOLOR}${USER_DEFINED_COMPONENT_SUBTYPE}${CLEARCOLOR}"
